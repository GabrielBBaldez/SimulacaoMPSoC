...
## Divisão
Esta trabalho foi divido em duas partes, sendo ela a primeira tentativa e depois de uma revisão com o professor uma nova versão foi implementada,
 mas para não perder as utilidades a primeira versão foi preservada.
